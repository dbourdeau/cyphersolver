...
def row(e):
    ...
    if e.get('scored') == 'sweep': noted += ' <span class="noted" title="added by the new-solves sweep of 22 Sept 2026, scored by hand from descriptions">new 22 Sept</span>'
