...
| p119 | **A correspondent at Randan (Auvergne; probably the comte de Randan) → the duc de Nevers, BnF fr. 3975 ff. 28, 30** (DECODE R4285, R4286) | 1587 | 2 | 2 | 4 | 4 | 1 | 3 | **2.60** | D 2: key in the Nevers key book, usable only after the writer's glyph forms were learnt from a glossed letter found in another volume (fr. 3413 f. 102, misattributed to the cardinal de Guise). H 2: Épernon's alarm near Lyon, the Auvergne correspondent's place. N 4: no reading anywhere. R 4: sibling hunted across volumes, DECODE's Rome corrected to Randan. V 3: 24 of 27 units, three single signs doubtful |
...
Randan correspondent to Nevers, March–April 1587 provisional score: 0.25×2 + 0.25×2 + 0.20×4 + 0.10×4 + 0.10×1 + 0.10×3 = **2.60** (p119): the Nevers key read the items once a glossed letter by the same hand taught its glyph forms.
