...
| p122 | **King John Zápolya and an agent at Buda → the dukes of Bavaria** (filed under Cornelio Sperantio), BayHStA KAA 4591 ff.248, 250–251 (DECODE R9411, R9412) | 1534 | 2 | 3 | 4 | 4 | 1 | 3 | **2.85** | D 2: the key came from a contemporary interlinear decipherment and matched a key already rebuilt for R9415. H 3: King John seeks Bavarian capital and miners for the Hungarian mines; Werbőczy's peace with the Turk. N 4: never read, never printed. R 4: 96% and 95%. V 3: the gloss key and the independent R9415 key agree. |
...
King John and a Buda agent to the dukes of Bavaria, February 1534 provisional score: 0.25×2 + 0.25×3 + 0.20×4 + 0.10×4 + 0.10×1 + 0.10×3 = **2.85** (p122): the key was on the page as a gloss and matched a sibling key; the value is the identification (not Sperantio's letters; one correspondence with R9415) and the German newsletter read without a gloss.
