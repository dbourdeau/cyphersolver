...
| p113 | **Scribe's colophon of the Dominican sequentiary Uppsala UB C 513**, f. 19v, Strängnäs (DECODE R4349) | 1517 | 1 | 1 | 1 | 2 | 1 | 5 | **1.50** | D 1: a vowel shift printed with its reading in the Uppsala catalogue (1992). H 1: the book's date and place, already known from the same print. The new work was locating the folio, the first letter-by-letter transcription and the DECODE corrections. |
...
Strängnäs sequentiary colophon 1517 provisional score: 0.25×1 + 0.25×1 + 0.20×1 + 0.10×2 + 0.10×1 + 0.10×5 = **1.50** (p113): already in print; the new work was the folio, the transcription and the DECODE corrections.
