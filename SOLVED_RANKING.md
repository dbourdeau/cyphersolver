...
| p117 | **The French commissioners at Calais (Chancellor Duprat) → Francis I**, BnF fr. 3092 ff. 101–107 (DECODE R3699–R3701) | 1521 | 1 | 4 | 4 | 3 | 1 | 4 | **2.85** | D 1: Lasry's published key, decoding only, over 4,549 hand-transcribed signs. H 4: the Calais conference of 1521 from the French side: Wolsey after Bruges, Gattinara, Albany's departure for Scotland. N 4: one of three memoirs printed online (Tomokiyo, from Lasry), two read here first. R 3: DECODE images, Gallica views and the BnF inventory matched. V 4: every letter sign read; f. 101 agrees with Lasry's text; two name signs open. |
...
Duprat at Calais 1521 provisional score: 0.25×1 + 0.25×4 + 0.20×4 + 0.10×3 + 0.10×1 + 0.10×4 = **2.85** (p117): Lasry's fr. 3029 key read all three fr. 3092 memoirs unchanged; two had no reading anywhere.
