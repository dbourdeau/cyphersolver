...
| p10 | **John Quincy Adams → Secretary of State**, St Petersburg, No. 88, 25 June 1812, M35 reel 3 | 1812 | 2 | 3 | 5 | 5 | 2 | 3 | **3.25** | Code rebuilt from the clerk's interlinear decodes and Ford's printed 1811 decipherments (962 numbers, 391 clerk-attested), not broken cold, after refuting the editorial premise that it was Armstrong's THE = 972. The nine lines Ford printed as not decyphered read 127 of 133 groups as sense (0.955); the whole despatch 355 of 390 (0.910, measured, 22 Sept 2026). Content: the Chancellor's strokes at Wilna on the eve of 1812, dated earlier than the standard accounts; Kurakin's note and Napoleon along the Baltic. Held down on completeness: read in part, ~20 groups of the remainder unread and a few readings that fail the sense |
