...
| p120 | **Ferdinand of Bavaria, Elector of Cologne → Duke Maximilian I of Bavaria, BayHStA KAA 4591 ff. 281–286** (DECODE R9426) | 1619 | 5 | 4 | 5 | 3 | 1 | 4 | **4.05** | D 5: ciphertext-only recovery of an unknown homophonic system from images, no key, no crib, the sender and the place unknown until the text gave them. H 4: the Catholic League's winter quarters and the case for the war, six weeks after the Prague coronation. N 5: no reading anywhere, and no printed edition of the letter. V 4: the key reads the sibling R9425 unchanged; 31 nomenclator groups stay open.
...
Ferdinand of Bavaria to Maximilian I, 22 December 1619 provisional score: 0.25×5 + 0.25×4 + 0.20×5 + 0.10×3 + 0.10×1 + 0.10×4 = **4.05** (p120): an unknown cipher, an unknown sender and an unknown place, all three recovered from the ciphertext alone; the key then read the sibling letter unchanged.
