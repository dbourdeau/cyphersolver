...
| p10 | **John Quincy Adams → Secretary of State**, St Petersburg, No. 88, 25 June 1812, M35 reel 3 | 1812 | 2 | 3 | 5 | 5 | 2 | 4 | **3.35** | Code rebuilt from the clerk's interlinear decodes and Ford's printed 1811–1812 decipherments (1,070 numbers), not broken cold, after refuting the editorial premise that it was Armstrong's THE = 972. Read, 376 of 390 groups as sense (0.964, measured, 22 Sept 2026): the nine lines Ford printed as not decyphered 129/133, the remainder 247/257. Content: the Chancellor's strokes at Wilna on the eve of 1812, dated earlier than the standard accounts; Lauriston on Kurakin's note ('even after the battle of Friedland'); Napoleon to strike at the centre of the empire rather than along the shores of the Baltic. Held down on completeness: 7 groups cut by the film's gutter, one encoding slip |
...
| p112 | **Dr Nicholas Wotton (Soissons) → Queen Mary I, 13 June 1554**, BL Harley MS 1582 ff. 8–10 (DECODE R8499) | 1554 | 3 | 4 | 4 | 3 | 1 | 2 | **3.15** | D 3: archive key found, but a sign transcription of ~3,200 signs had to be rebuilt against it eight times. H 4: Carew and the rebels of 1554 at the French court, the Isle of Wight and Plymouth. N 4: not in print. V 2: 75% firm, read in part. |
| p113 | **Scribe's colophon of the Dominican sequentiary Uppsala UB C 513**, f. 19v, Strängnäs, and the f. 1r note (DECODE R4349) | 1517 | 1 | 1 | 2 | 3 | 1 | 3 | **1.55** | D 1: the colophon's vowel shift was printed with its reading (1992); the six signs of the f. 1r note are too short. H 1: the book's date and place, and a private note. N 2: the note and its signs are new here. R 3: all 175 images checked to find the six signs DECODE means. |
| p114 | **Ferenc Wesselényi → Leopold I, MNL OL E 199 8.1.01** (DECODE R674) | c. 1663–64 | 3 | 3 | 5 | 3 | 1 | 4 | **3.30** | D 3: ciphertext-only, but a simple reversed alphabet with four vowel homophones inside Latin clear text; an annealer with an LM broke it. H 3: the Palatine's plan to force an imperial garrison on a town in the Turkish war, 1663–64. N 5: no reading anywhere. R 3: sibling keys fetched and scored, R672 found. F 1: catalogue only. V 4: every letter read, alphabet confirmed by R672; two codes open. |
| p115 | **Jörg Weinmeister (Hungary) → the Dukes of Bavaria**, BayHStA KAA 4591 ff. 232–235 (DECODE R9407) | 1533 | 3 | 4 | 5 | 4 | 1 | 3 | **3.55** | A sibling's glossed key carried over by sign shapes, then EM, a word-aware decoder and reading rounds against the images; the sender identified from his ciphered signature. Móré at Palota, the diet of Pressburg, 50,000 Turks from Belgrade. Read at 96.7% once the overlooked sixth image (f. 235r) was fetched; dated to spring 1533 by the siege of Palota |
| p116 | **Paris informant (same as ff. 62, 131) → the Nevers household, BnF fr. 3976 ff. 133–134** (DECODE R3708) | 1588 | 2 | 4 | 4 | 3 | 1 | 4 | **3.10** | D 2: sibling key (f. 62/f. 131) applied, three signs added from context. H 4: the League municipality and Guise's council three weeks after the Barricades. N 4: not in print. V 4: 226 of 230 signs by the key; also corrects code 24 to Nevers. |
| p118 | **Catherine de Médicis (Chenonceau) → Villeroy, 7 Feb 1581**, BnF fr. 15564 f. 33r (DECODE R4157) | 1581 | 1 | 3 | 1 | 3 | 1 | 5 | **2.10** | D 1: Tomokiyo's key in print, split and extended by twelve values. H 3: Anjou and the Low Countries, the embassy to England. N 1: deciphered at the time and printed 1899. R 3: DECODE's sender and 1587 date corrected from the docket and the edition. V 5: every sign accounted for, agrees with the contemporary decipherment. |
| p119 | **A correspondent at Randan (Auvergne; probably the comte de Randan) → the duc de Nevers, BnF fr. 3975 ff. 28, 30** (DECODE R4285, R4286) | 1587 | 2 | 2 | 4 | 4 | 1 | 4 | **2.70** | D 2: key in the Nevers key book, usable only after the writer's glyph forms were learnt from a glossed letter found in another volume (fr. 3413 f. 102, misattributed to the cardinal de Guise). H 2: Épernon's alarm near Lyon, the Auvergne correspondent's place. N 4: no reading anywhere. R 4: sibling hunted across volumes, DECODE's Rome corrected to Randan. V 4: 26 of 27 units; one sign taken as a null, two found struck out |
| p120 | **Burghley (Westminster) → Walsingham, early 1573**, BL Harley MS 260 f. 419 (DECODE R8364) | 1573 | 2 | 2 | 4 | 4 | 1 | 2 | **2.50** | D 2: one word read by aligning five copies across letters and an archive catalogue entry, no key. H 2: the St Valery ship for the Archbishop of Glasgow's gentleman. N 4: no reading in print. R 4: all 457 Digges pages scanned, key and originals traced. V 2: 23% of tokens, grade M. |
| p121 | **Ferdinand of Bavaria, Elector of Cologne → Duke Maximilian I of Bavaria, BayHStA KAA 4591 ff. 281–286** (DECODE R9426) | 1619 | 5 | 4 | 5 | 3 | 1 | 4 | **4.05** | D 5: ciphertext-only recovery of an unknown homophonic system from images, no key, no crib, the sender and the place unknown until the text gave them. H 4: the Catholic League's winter quarters and the case for the war, six weeks after the Prague coronation. N 5: no reading anywhere, and no printed edition of the letter. V 4: the key reads the sibling R9425 unchanged; 31 nomenclator groups stay open.
| p122 | **Guido Rangone (Venice) → Anne de Montmorency, BnF fr. 3070 f. 81 and fr. 3082 f. 42** (DECODE R4249) | 1529–30 | 5 | 2 | 5 | 4 | 1 | 2 | **3.45** | D 5: ciphertext-only recovery of an unknown homophonic system of ~50 signs from 264 signs, no key, no crib. H 2: a condottiere's grievance over Venice's offers to his brother-in-law Cesare Fregoso. N 5: no reading anywhere. R 4: the sibling traced through the Clairambault volume concordance; four more letters checked. V 2: 87.9% read, four short runs open.
| p123 | **King John Zápolya and an agent at Buda → the dukes of Bavaria** (filed under Cornelio Sperantio), BayHStA KAA 4591 ff.248, 250–251 (DECODE R9411, R9412) | 1534 | 2 | 3 | 4 | 4 | 1 | 3 | **2.85** | D 2: the key came from a contemporary interlinear decipherment and matched a key already rebuilt for R9415. H 3: King John seeks Bavarian capital and miners for the Hungarian mines; Werbőczy's peace with the Turk. N 4: never read, never printed. R 4: 96% and 95%. V 3: the gloss key and the independent R9415 key agree. |
| p124 | **Four cipher letters to Gianfrancesco Gonzaga, Rome and Forlì** (DECODE R1854, Mantua) | 1428–30 | 5 | 3 | 5 | 4 | 1 | 3 | **3.80** | D 5: two unknown homophonic systems (1,802 and 1,736 signs) broken ciphertext-only from images, glyph splits found by the solver; a third keyed from a faint contemporary gloss. H 3: Gonzaga marriage diplomacy, Malatesta–Urbino intrigue, the archbishop of Patras offering his see to Venice. N 5: no reading anywhere before, DECODE had no metadata. R 4: register and all Mantua records searched. V 3: three letters 96.6–100%, the fourth unread. |
| p125 | **Vatican Challenge Part 5 (Farnese → Poggio)** (DECODE R92, AAV Spagna 1A) | 1542 | 1 | 3 | 1 | 3 | 4 | 4 | **2.30** | D 1: solved by Simon Klee, not here; the attacks made here failed and misdiagnosed the system. H 3: papal aid against the Turks, the Diet of Speyer, the Gonzaga. N 1: Klee's reading preceded the review. R 3: seven sessions, DECODE images read against the transcript. F 4: a public MysteryTwister challenge set by Lasry in 2019. V 4: independent half-text recoveries and controls; damaged passages provisional. |
| p126 | **Pseudo-Johann Arndt, Das zweyte Silentium Dei**, Beinecke Mellon MS 136 (DECODE R2873) | 1798 | 1 | 1 | 2 | 3 | 2 | 4 | **1.80** | D 1: the key is drawn in the book. H 1: recipe words for an alchemical burning-glass machine. N 2: p. 24 read online in 2022, short passages partly; five passages new. F 2: Schmeh's Encrypted Book List no. 00114. V 4: every passage read, two signs open |
...
Visconti to Montmorency 1528 provisional score: 0.25×2 + 0.25×3 + 0.20×4 + 0.10×3 + 0.10×1 + 0.10×3 = **2.75** (p106): Lasry's published key extended on an unread letter, read in part.
...
Wotton to Queen Mary 13 June 1554 provisional score: 0.25×3 + 0.25×4 + 0.20×4 + 0.10×3 + 0.10×1 + 0.10×2 = **3.15** (p112): read in part with the SP 106 key R354; the contemporary decipherment at ff. 5r–7v is not digitised.
Strängnäs sequentiary 1517 provisional score: 0.25×1 + 0.25×1 + 0.20×2 + 0.10×3 + 0.10×1 + 0.10×3 = **1.55** (p113): the colophon was in print; the six-sign note DECODE means is too short to read.
Wesselényi to Leopold I c. 1663–64 provisional score: 0.25×3 + 0.25×3 + 0.20×5 + 0.10×3 + 0.10×1 + 0.10×4 = **3.30** (p114): read ciphertext-only; the alphabet later confirmed by DECODE key R672.
Weinmeister to the Dukes of Bavaria, spring 1533 provisional score: 0.25×3 + 0.25×4 + 0.20×5 + 0.10×4 + 0.10×1 + 0.10×3 = **3.55** (p115): an unread, unattributed letter read to 96.7%, the writer named from the cipher itself
Paris informant to the Nevers household, 6 June 1588 provisional score: 0.25×2 + 0.25×4 + 0.20×4 + 0.10×3 + 0.10×1 + 0.10×4 = **3.10** (p116): the sibling key read a third letter of the same informant end to end.
Catherine de Médicis to Villeroy, 7 Feb 1581 provisional score: 0.25×1 + 0.25×3 + 0.20×1 + 0.10×3 + 0.10×1 + 0.10×5 = **2.10** (p118): a key and a decipherment already existed; the work identified the letter, extended the key and explained the unread last line.
Randan correspondent to Nevers, March–April 1587 provisional score: 0.25×2 + 0.25×2 + 0.20×4 + 0.10×4 + 0.10×1 + 0.10×4 = **2.70** (p119): the Nevers key read the items once a glossed letter by the same hand taught its glyph forms.
Burghley to Walsingham early 1573 provisional score: 0.25×2 + 0.25×2 + 0.20×4 + 0.10×4 + 0.10×1 + 0.10×2 = **2.50** (p120): one place name read from its repetitions across the correspondence; the rest needs the 1571 key.
Ferdinand of Bavaria to Maximilian I, 22 December 1619 provisional score: 0.25×5 + 0.25×4 + 0.20×5 + 0.10×3 + 0.10×1 + 0.10×4 = **4.05** (p121): an unknown cipher, an unknown sender and an unknown place, all three recovered from the ciphertext alone; the key then read the sibling letter unchanged.
Guido Rangone to Montmorency, 24 Dec 1529 and 10 Jan 1530 provisional score: 0.25×5 + 0.25×2 + 0.20×5 + 0.10×4 + 0.10×1 + 0.10×2 = **3.45** (p122): an unknown homophonic cipher broken ciphertext-only on a short text, read in part.

King John and a Buda agent to the dukes of Bavaria, February 1534 provisional score: 0.25×2 + 0.25×3 + 0.20×4 + 0.10×4 + 0.10×1 + 0.10×3 = **2.85** (p123): the key was on the page as a gloss and matched a sibling key; the value is the identification (not Sperantio's letters; one correspondence with R9415) and the German newsletter read without a gloss.
Cipher letters to Gianfrancesco Gonzaga, 1428–30 provisional score: 0.25×5 + 0.25×3 + 0.20×5 + 0.10×4 + 0.10×1 + 0.10×3 = **3.80** (p124): three letters in two unknown homophonic systems and a glossed one, read; Pandolfo Malatesta's runs open.
