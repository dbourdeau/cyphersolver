...
| p115 | **Jörg Weinmeister (Hungary) → the Dukes of Bavaria**, BayHStA KAA 4591 ff. 232–235 (DECODE R9407) | 1535 | 3 | 4 | 5 | 4 | 1 | 3 | **3.55** | A sibling's glossed key carried over by sign shapes, then EM, a word-aware decoder and reading rounds against the images; the sender identified from his ciphered signature. Móré at Palota, the diet of Pressburg, 50,000 Turks from Belgrade. Two pages over the read bar, the third cut off by the photograph |
...
Weinmeister to the Dukes of Bavaria, 10 Dec 1535 provisional score: 0.25×3 + 0.25×4 + 0.20×5 + 0.10×4 + 0.10×1 + 0.10×3 = **3.55** (p115): an unread, unattributed letter read to ~89%, the writer named from the cipher itself
