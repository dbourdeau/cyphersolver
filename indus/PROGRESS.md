...
|---|---|---|---|
| 1 | V meaning, checked | share of sign tokens read as sense and checked against archaeological evidence: the object's iconography (copper tablets, seal motifs), its function (weights, tags, pottery), its find context, West Asian texts naming Meluhha. Numerals reported beside it (their sense is the count). | 0.008% (4 copper-tablet signs); numerals 16.6%; referent fixed by the picture (not read) 2.28% (185 texts and units: sign pairs and 3-sign runs at 2+ objects / 67%+ (sets 287-288); single signs, skip-pairs and sign-family units at 3+ objects / 67%+ (sets 303-307); combined FDR 7.8%; UNCONFIRMED upper figure: a split-half check is mixed, p = 0.002 and 0.058, held-out precision 21-25% (set 308) on individually made tablets and across distinct moulded designs, pictured fragments included, part-texts merged; sets 233, 237, 243, 254; criteria calibrated in set 287: 2+ objects, 67%+ one picture, FDR 9.4% against picture shuffles; 0.79% at the stricter earlier criteria). Caveat: these are local labels; they do not transfer between tablet types (1 of 40 cross-type predictions right, observation after set 243) |
...
| 111 | 286 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | S: damaged-text runs with cut edges marked raise S (4.6354 to 4.6712) and A to B (5.1938 to 5.2105); SIGN 39.6 to 39.8% (no progress; streak 2) |
| 112 | 287 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: referent criteria calibrated by false-discovery rate against picture shuffles: k 2 objects, share 0.67 gives 55 units (shuffles 5.2, FDR 9.4%) against 27 (FDR 2.5%); Linear B control still passes; referent line 0.79% to 1.38% (progress; streak 0) |
| 113 | 288 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: 3-sign runs added as referent units (68 units, FDR 9.8%), referent line 1.38% to 1.46%; single signs push FDR to 10.8%, not adopted (806 = human figure on made tablets, plant on moulded ones: labels stay local) (progress; streak 0) |
| 114 | 289 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: picture vault with referent units, 26 of 74 held-out tablets' pictures right (35.1%; was 16.9%), both pools above their shuffle medians, but pooled p = 0.19: accuracy on the few predictions shuffles make is too noisy a statistic (no progress; streak 1) |
| 115 | 290 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: picture vault by correct predictions: referent units learned without copies of the held-out text predict 26 held-out tablets' pictures (35% of those predicted) against a shuffle median of 1 (95th pct 7, p = 0.005); Linear B control 710 of 1,716 lines against a shuffle max of 22 (progress; streak 0) |
| 116 | 291 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: seals with the calibrated criterion give 5 non-default units (all gaur) against 2.2 in shuffles (FDR 43%): seal texts still do not name their animal (no progress; streak 1) |
| 117 | 292 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: skip-pairs would raise the referent line to 1.65% but push FDR to 10.2%, over the 10% rule; not adopted (no progress; streak 2) |
| 118 | 293 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: referent units sit where other recurring units sit (made 0.62 vs 0.57, p = 0.49; moulded 0.55 vs 0.58, p = 0.46): no fixed slot for the object word (no progress; streak 3) |
| 119 | 294 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: picture vault with all unit kinds (single signs, pairs, 3-sign runs, skip-pairs): 64 of 191 held-out tablets' pictures right (33.5%) against a shuffle median of 4 (95th pct 14, p = 0.005) (progress; streak 0) |
| 120 | 295 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: single-object units raise correct held-out pictures to 81 of 325 but chance to 28 (excess +53 against set 294's +60; accuracy 24.9%); the registered rule held, withdrawn on audit (no progress; streak 1) |
| 121 | 296 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: weighted vault votes do slightly worse than one vote per unit (61 of 191, excess +56 against +60; accuracy 31.9%) (no progress; streak 2) |
| 122 | 297 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: specificity-weighted vault votes 62 of 191 (excess +57 against +60): one vote per unit is as good as any weighting tried (no progress; streak 3) |
| 123 | 298 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: cross-pool fallback in the vault: 70 of 295 held-out pictures right, shuffle median 6, excess +64 against +60 (p = 0.005); the 104 fallback tablets add about 4 beyond chance: labels mostly stay in their pool (progress, small; streak 0) |
| 124 | 299 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: cross-site referents held as registered but withdrawn on audit: one hit Harappa to Mohenjo-daro; 17 of 22 the other way predict 'Mult' (a genre label), 3 are part-text leaks; referents do not travel between cities. In-pool vault hits audited: bull 30, plant 20, fish 7 (no progress; streak 1) |
| 125 | 300 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: referent units over Parpola's sign families would reach 2.87% but FDR is 11.5% (coarser units match by chance); not adopted (no progress; streak 2) |
| 126 | 301 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: sign-family units in the vault reach 386 tablets but add only chance hits (72 correct, median 9, excess +63 against +64; accuracy 18.7%) (no progress; streak 3) |
| 127 | 302 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 3: vault without catch-all votes (Mult, Scene, Comp) 68 of 292, excess +63 against +64: the catch-all votes were neither helping nor hurting much (no progress; streak 4) |
| 128 | 303 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: single signs under a stricter criterion (3+ objects, 80%+) join the referent units: 17 signs (923 elephant, 790 goat, 4 pipal, 17 / 318 / 440 / 503 gharial ...), combined FDR 9.1%; referent line 1.46% to 1.62% (progress; streak 0) |
| 129 | 304 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: under the stricter criterion skip-pairs (FDR 7.6%, 1.70%) and family units (FDR 9.6%, 1.80%) both pass; family units adopted (registered rule: larger coverage); referent line 1.62% to 1.80% (progress; streak 0) |
| 130 | 305 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: strict skip-pairs join the family units: 119 units, FDR 8.3%; referent line 1.80% to 1.87% (progress; streak 0) |
| 131 | 306 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: strict family single signs and skip-pairs join: 136 units, FDR 6.7%; referent line 1.87% to 1.89% (progress, small; streak 0) |
| 132 | 307 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1: the single-sign, skip-pair and family kinds at 3+ objects, 67%+ (not 80%+): 185 units, FDR 7.8%; referent line 1.89% to 2.28% (progress; streak 0) |
| 133 | 308 | 4.635 (26.1%) | 86.3% | 16.6% (M+ 41.4%) | 0 | 4 (L world 85.1%) | tier 1 validation: split-half check of the tuned referent configuration is mixed (p = 0.002 one way, 0.058 the other; held-out precision 21-25%): the 2.28% line is downgraded to an unconfirmed upper figure (no progress; streak 1) |
