...
| 3 | U vault | share of tokens in texts never used to fix the values (B's new lines; later, newly excavated finds) read as sense with values fixed beforehand | 0 (no sound value has passed); sign restorations checked against an outside transcription (set 283: illegible ICIT signs predicted by a model retrained without copies of the text, compared with Mahadevan 1977's readings: top-1 4 of 15, top-5 9 of 15, frequency baseline 3 of 15; narrow, a sign-level check, not meaning); picture vault: weak; leave-one-out 16.9% (p = 0.05), 13.6% with near duplicates together (p = 0.14), 49 of 50 splits above the null median (sets 201-203) |
