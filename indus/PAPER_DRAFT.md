...
class-suffix test, only Dravidian passes both grammar tests outright; and of 197 predictions registered before
testing, 73 held and 124 failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (73 held, 124 failed). Wells (2006) preferred Munda
