...
class-suffix test, only Dravidian passes both grammar tests outright; and of twenty-four predictions registered before
testing, eleven held and thirteen failed; the held ones are structural (head-final names, bound pairs kept whole
across line breaks, free signs in foreign names, a Linear B-calibrated shortlist of candidate sound signs). No sound value is established. We describe what the corpus supports and what
...
bench validated on Linear Elamite, and the registered predictions (eleven held, thirteen failed). Wells (2006) preferred Munda
