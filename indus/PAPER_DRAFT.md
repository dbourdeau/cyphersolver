...
class-suffix test, only Dravidian passes both grammar tests outright; and of eighty-seven predictions registered before
testing, thirty-one held and fifty-six failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (thirty-one held, fifty-six failed). Wells (2006) preferred Munda
