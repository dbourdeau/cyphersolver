...
class-suffix test, only Dravidian passes both grammar tests outright; but of twenty predictions registered before
testing, thirteen failed. No sound value is established. We describe what the corpus supports and what
...
bench validated on Linear Elamite, and the registered predictions (seven held, thirteen failed). Wells (2006) preferred Munda
