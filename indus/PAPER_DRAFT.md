...
class-suffix test, only Dravidian passes both grammar tests outright; but two predictions of the Dravidian model,
registered before testing, failed. No sound value is established. We describe what the corpus supports and what
