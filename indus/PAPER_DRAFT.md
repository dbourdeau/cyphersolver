...
class-suffix test, only Dravidian passes both grammar tests outright; and of fifty-two predictions registered before
testing, seventeen held and thirty-five failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (seventeen held, thirty-five failed). Wells (2006) preferred Munda
