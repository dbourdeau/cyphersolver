...
class-suffix test, only Dravidian passes both grammar tests outright; and of 112 predictions registered before
testing, 43 held and 69 failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (43 held, 69 failed). Wells (2006) preferred Munda
