...
class-suffix test, only Dravidian passes both grammar tests outright; and of sixty-two predictions registered before
testing, eighteen held and forty-four failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (eighteen held, forty-four failed). Wells (2006) preferred Munda
