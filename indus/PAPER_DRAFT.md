...
class-suffix test, only Dravidian passes both grammar tests outright; but of ten predictions registered before
testing, eight failed. No sound value is established. We describe what the corpus supports and what
...
bench validated on Linear Elamite, and the registered predictions (two held, eight failed). Wells (2006) preferred Munda
