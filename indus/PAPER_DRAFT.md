...
class-suffix test, only Dravidian passes both grammar tests outright; and of twenty-seven predictions registered before
testing, eleven held and sixteen failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (eleven held, sixteen failed). Wells (2006) preferred Munda
