...
class-suffix test, only Dravidian passes both grammar tests outright; and of 137 predictions registered before
testing, 50 held and 87 failed; the held ones are structural (head-final names, bound pairs kept whole
...
bench validated on Linear Elamite, and the registered predictions (50 held, 87 failed). Wells (2006) preferred Munda
