...
PIN={'ll':'o','sy':'w','x_':'s','e/':'g','-8':'c','pt':'u','F':'u','d':'i','E':'c','xi':'o','7':'m','z':'i','<':'g','#':'e','mu':'n','x':'p','8':'e','ct':'e','^':'n','H':'y','S':'a','v':'a','x=':'e','Z=':'d','h':'k','ex':'s','+':'r'}
R=[]
...
if __name__=='__main__':
  ...
  json.dump({'key':key,'text':txt},open(f'pin8_{sys.argv[1]}.json','w'))
