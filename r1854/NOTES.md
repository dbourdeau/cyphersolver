...
- [x] retry (2): P1 tested for digraphic (pair IC 0.005), periodic/polyalphabetic (flat column IC, periods 2-8) and transposed text (vowel alternation 0.713 > 200 shuffles: linear substituted text); annealed in Spanish, Catalan, French, German, Portuguese and order-3 Latin/Italian with 150 restarts: no reading
