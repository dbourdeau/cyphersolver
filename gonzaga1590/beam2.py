...
K = {11: 'm', 12: 'f', 13: 'a', 14: 'h', 15: 'e', 16: 'n', 17: 'p', 18: 'g', 19: 'b', 20: 'z', 21: 'd', 22: 'a',
     ...
     37: 'i', 38: 'a', 39: 'o', 40: 's'}
ALT0 = {'3': '39', '9': '93', '0': '08', '8': '807', '1': '1', '2': '2', '4': '4', '5': '5', '6': '6', '7': '78'}
PEN_ALT = 6.0
PEN_ANY = float(os.environ.get('PEN_ANY','11'))      # cost of reading a digit as its look-alike
PEN_CODE = 16.0     # cost of a code-word token
ALT = {d: ALT0[d] + ''.join(x for x in '0123456789' if x not in ALT0[d]) for d in ALT0}
            ...
            if p + 1 < n and toks[p + 1].isdigit():
                for a in ALT[t]:
                    for b in ALT[toks[p + 1]]:
                        pen = sum(0 if x == y else (PEN_ALT if x in ALT0[y] else PEN_ANY) for x, y in ((a, t), (b, toks[p + 1])))
                        v = int(a + b)
                        if v in K:
                            for ch in K[v]:
