...
25 Sept 2026: 180 (Camouflage Part 6) solved and accepted on the 1st attempt; 110 (ASAC Part 3) solved, answer ready (unseeded rand() weakness); Weakened ElsieFour Parts 1-3 in progress (SAT attack).
...
| 110 | ASAC – A Strong(er) ADFGVX Cipher, Part 3 | II | Solved 25 Sept 2026 (not yet submitted): the program never seeds rand(), so each homophone's draw is known; keystream and 22-column transposition recovered, then the square; every cell consistent with the replayed rand() | `110-asac3/` |
