...
four signs read from context only; the code numbers are partly identified.
...
| 4, 10, 23, 25, 33, 79, 94, 105, 106 | not identified | 4, 9, 24, 94 are candidates Paris offers the King "a son choix" (a governor?) |
...
- Code numbers 4, 10, 23, 25, 33, 79, 94, 105, 106: open-codes; the informant's number list is not known and the
  sibling letters gloss only 11 and 24.

## Escalation

- siblings: done. ff. 62 (R3705) and 131 give the key; f. 131's gloss over 24 re-read as "nevers". f. 139 (9 June)
  not checked for further code glosses.
