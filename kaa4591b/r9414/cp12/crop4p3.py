...
A=(P[0]+[P[0][-1]+103*j for j in range(1,5)])[:40]
...
for k in range(1,40):
    ...
    C.append(row)
C=[[c-100 for c in C[0]]]+C
d=[r[3] for r in C][1:]; d.append(d[-1]+103)
for r,v in zip(C,d): r[3]=v
FIX={}
for k in range(40):
    strips=[]
    for b in range(4):
    ...
    out.save(f'cp12/p3h/P3_{k+1:02d}.png')
for k in range(40): print(k+1,C[k])
