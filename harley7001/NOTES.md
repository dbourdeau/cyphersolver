...
## Remaining gaps
- code groups 90, 160, 319, 359, 444, 452, 455, 487, 539, 650, 673, 718 (x2) - blocker: no-key-material; blank in the only surviving key reconstruction (R9115); the only further source is Reade's other ciphered letters to Thomas Windebank, Paris, Jan-May 1641, calendared in CSP Domestic 1640-41 (TNA SP 16/476 ff., 'some sentences in cipher', printed unread) - needs-physical-access (TNA originals, not on DECODE or free online); each occurs once or twice, conjectured from context and alphabetical slot (6% of tokens; 203 done and 729 Court were later found as side notes on the key sheet)
